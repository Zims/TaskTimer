...
class AddEditFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            if (task != null) {
                ...
                //no task so we must be adding new task, and editing existing one
    ...
    private fun saveTask() {
        //update db if at least 1 field is changed
        var sortOrder = if (addedit_sortorder.text.isNotEmpty()){
